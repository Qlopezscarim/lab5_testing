...
set name top_fpext_32ns_64_2_no_dsp_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_sparsemux_9_3_17_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_r \
    op interface \
    ports { input_r_address0 { O 10 vector } input_r_ce0 { O 1 bit } input_r_we0 { O 1 bit } input_r_d0 { O 17 vector } } \
} "
} else {
...
set InstName top_flow_control_loop_delay_pipe_U
set CompName top_flow_control_loop_delay_pipe
