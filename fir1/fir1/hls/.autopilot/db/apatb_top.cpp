...
// wrapc file define:
#define AUTOTB_TVIN_in_r "../tv/cdatafile/c.top.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in_r "../tv/cdatafile/c.top.autotvout_in_r.dat"
...
#define AUTOTB_TVOUT_N "../tv/cdatafile/c.top.autotvout_N.dat"
...
extern "C"
void top_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_top_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_out_r, hls::sim::Byte<4> __xlx_apatb_param_N)
{
  ...
  port3.mname = { "in_r", "out_r" };
  port3.nbytes = { 4000, 4000 };
  for (size_t off = 0, i = 0; i < port3.nbytes.size(); ++i) {
    port3.offset.push_back(off);
    off += hls::sim::divide_ceil(port3.nbytes[i], port3.asize);
  }
  __xlx_offset_byte_param_in_r = port3.offset[0]*32;
  __xlx_offset_byte_param_out_r = port3.offset[1]*32;
  ...
  try {
    ...
    top_hw_stub_wrapper(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r, __xlx_apatb_param_N);
