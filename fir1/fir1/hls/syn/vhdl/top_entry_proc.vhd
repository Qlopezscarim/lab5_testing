...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, out_r_c_full_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (out_r_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    out_r_c_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_r_c_full_n)
    begin
    ...
    out_r_c_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
